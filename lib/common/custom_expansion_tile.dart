  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    return Container(
      decoration: BoxDecoration(
          ...
          border: Border(
            top: BorderSide(color: widget.headerBackgroundColor, width: 0.0),
            bottom: BorderSide(color: widget.headerBackgroundColor, width: 0.0),
            left: BorderSide(color: widget.headerBackgroundColor, width: 0.0),
            right: BorderSide(color: widget.headerBackgroundColor, width: 0.0),
          )),
