...
class ClaimInfoUserModel extends Equatable {
  const ClaimInfoUserModel({
    required this.cno,
  ...
  factory ClaimInfoUserModel.fromJson(Map<String, dynamic> json) => ClaimInfoUserModel(
      cno: json['cno'],
  ...
  ClaimInfoUser toEntity() {
    return ClaimInfoUser(
      cno: cno,
      benefitName: benefitName,
      verified: verified,
      accepted: accepted,
